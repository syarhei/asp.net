...
<body>
    ...
    <div>
        ...
        <p>
            <asp:TextBox ID="mail" runat="server" ValidationGroup="v1"></asp:TextBox>
            <asp:Label ID="Label4" runat="server" Text="Почта"></asp:Label>
        </p>
         <p>
            <asp:TextBox ID="sum" runat="server" ValidationGroup="v1"></asp:TextBox>
             <asp:Label ID="Label5" runat="server" Text="Сумма"></asp:Label>
        </p>
        <p>
            <asp:TextBox ID="bday" runat="server" ValidationGroup="v1"></asp:TextBox>
            <asp:Label ID="Label6" runat="server" Text="Дата рождения"></asp:Label>
        </p>
        <p>
            <asp:TextBox ID="pass" TextMode="Password" runat="server" ValidationGroup="v1"></asp:TextBox>
        ...
        ErrorMessage="Невалидный адресс" ControlToValidate="mail" ValidationGroup="v1"
